      ...
      >
        ...
        <div className="mb-12 flex flex-col items-center gap-4 text-slate">
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="font-mono text-cyan text-[min(4vw,1rem)] sm:text-base whitespace-nowrap">
              Email:
            </span>
            <span className="text-[min(4vw,1rem)] sm:text-base whitespace-nowrap">
              dinhquangthanh0107@gmail.com
            </span>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="font-mono text-cyan text-[min(4vw,1rem)] sm:text-base whitespace-nowrap">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-[min(3.2vw,1rem)] sm:text-base whitespace-nowrap">
              Binh Thanh, Ho Chi Minh City, Viet Nam
            </span>
          </div>
        </div>
          ...
          {showForm && (
            ...
            >
              <form
                ...
                className="space-y-6 rounded-lg border border-lightest-navy bg-light-navy p-8 shadow-2xl"
              >
                {isSuccess && (
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div>
                    <label
                      htmlFor="name"
                      className="mb-2 block font-mono text-sm text-cyan"
                    >
                      $ name
                    </label>
                    <input
